<?php
    ...
    include_once "C:\Users\abril\OneDrive\Documentos\IPOO\php\IPOO-PrimerParcial2025\Aerolinea.php";
    ...
    $aerolinea1 = new Aerolinea(123, "FlyBondi", [$vuelo1, $vuelo2]);
    $aerolinea2 = new Aerolinea(321, "JetSmart", [$vuelo3, $vuelo4]);
    ...
    $venta = $aeropuerto->ventaAutomatica(3, "11/11/2025", "Bahia");
    echo $venta 
        ? "\nLa venta fue exitosa."
        : "\nLa venta no fue exitosa.\n";
    echo $aeropuerto;
